...
{
    public partial class frmConsultasVariasOP : Form
    {
        public frmConsultasVariasOP()
        {
            InitializeComponent();
        }
        clsBaseDatos sql = new clsBaseDatos();
        private void frmConsultasVariasOP_Load(object sender, EventArgs e)
        {
            btnListarConsultasBD.Enabled = false;
        ...
        private void cmbTabla_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbTabla.SelectedIndex != -1) btnListarConsultasBD.Enabled = true;
            else btnListarConsultasBD.Enabled = false;
        }

        private void btnListarConsultasBD_Click(object sender, EventArgs e)
        {
             String varSql = "";
